...
import { Component, LineDescRef } from '@guinguin-instruments/boardui-parser';
import { ElementIdProvider } from '../element-id-provider';
import { ComponentRenderProperties, RenderProperties } from '@guinguin-instruments/boardui-core';
